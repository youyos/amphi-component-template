...
PACKAGE_NAME="amphi-ai27-components-$VERSION"
...
cp "$PROJECT_DIR/python-requirements.txt" "$STAGING_DIR/python-requirements.txt"
cp "$REPOSITORY_DIR/docs/多语言与文档报告组件.md" "$STAGING_DIR/COMPONENTS.md"
